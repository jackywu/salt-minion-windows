...
!define PRODUCT_VERSION "2014.7.4"
...
Function .onInstSuccess
  Exec "nssm.exe install salt-minion c:\salt\salt-minion.exe -c c:\salt\conf -l quiet"
  RMDir /R "c:\salt\var\cache\salt" ; removing cache from old version
